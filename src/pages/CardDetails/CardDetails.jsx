...
function CardDetails() {
  ...
  const itemsInCart = () =>
    cart && cart.find((cartItem) => cartItem._id === id);
  const itemsInWishlist = () =>
    wishlist && wishlist.find((wishlistItem) => wishlistItem._id === id);
    ...
    (async function getItems() {
      try {
        const result = await axios.get(
          `https://crickart.herokuapp.com/product/${id}`
        );
        setLoading(false);
          ...
          {product !== undefined && (
            <>
              <div className="cardDetails__left">
                ...
                <div className="cardDetails__img">
              ...
              <div className="cardDetails__right">
                ...
                <div className="cd__details">
                  <p className="cardDetails__price">
                    Price : ₹ {product.price}{" "}
                  </p>
                  <p className="cardDetails__price discount">
                    {" "}
                    {product.discount}%{" "}
                  </p>
                  <p className="cardDetails__price netprice">
                    {" "}
                    ₹ {product.netPrice}{" "}
                  </p>
                </div>
                {itemsInCart() ? (
                  <Link to="/cart">
                    <button className="btn button-primary">
                      <i className="fa fa-shopping-cart">Go to Cart </i>
                    </button>
                    <ToastContainer />
                  </Link>
                ) : (
